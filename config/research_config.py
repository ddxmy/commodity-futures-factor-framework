...
class ResearchConfig:
    ...
    signal_min_days_to_maturity: int = 0
    trade_min_days_to_maturity: int = MIN_DAYS_TO_MATURITY
    ...
    def __post_init__(self) -> None:
        ...
        maturity_fields = {
            "signal_min_days_to_maturity": self.signal_min_days_to_maturity,
            "trade_min_days_to_maturity": self.trade_min_days_to_maturity,
        }
        for name, value in maturity_fields.items():
            if (
